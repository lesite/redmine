class TimeTrackersController < ApplicationController
    ...
    def start
        ...
        if @time_tracker.nil?
            ...
            if @time_tracker.save
                apply_status_transition(@issue) unless Setting.plugin_redmine_time_tracker_with_seconds['status_transitions'] == nil
                render_menu
            else
    ...
    def apply_status_transition(issue)
        new_status_id = Setting.plugin_redmine_time_tracker_with_seconds['status_transitions'][issue.status_id.to_s]
