...
class TimeTrackerHooks < Redmine::Hook::ViewListener
    ...
    def view_layouts_base_html_head(context = {})
        css = stylesheet_link_tag 'time_tracker.css', :plugin => 'redmine_time_tracker_with_seconds'
        js = javascript_include_tag 'time_tracker.js', :plugin => 'redmine_time_tracker_with_seconds'
        css + js
    end
end
